...
DEPS += emqttd emq_modules emq_dashboard emq_retainer emq_recon emq_reloader \
        ...
        emq_lua_hook emq_auth_jwt emq_es_storage emq_cleanspeak_plugin emq_throttle_plugin \
...
dep_emq_cleanspeak_plugin = git https://github.com/lucbarr/emq_cleanspeak_plugin.git master
dep_emq_throttle_plugin = git https://github.com/lucbarr/emq_throttle_plugin.git v1.4
