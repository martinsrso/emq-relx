...
DEPS += emqttd emq_modules emq_dashboard emq_retainer emq_recon emq_reloader \
        ...
        emq_lua_hook emq_es_storage emq_auth_jwt emq_cleanspeak_plugin emq_throttle_plugin \
...
dep_emq_cleanspeak_plugin = git https://github.com/lucbarr/emq_cleanspeak_plugin develop
dep_emq_throttle_plugin = git https://github.com/topfreegames/emq_throttle_plugin.git v1.4

# COVER = true

NO_AUTOPATCH = emq_es_storage emq_cleanspeak_plugin
