...
# emq deps
dep_emqttd        = git https://github.com/emqtt/emqttd v2.1.0
dep_emq_modules   = git https://github.com/emqtt/emq-modules v2.1.0
dep_emq_dashboard = git https://github.com/emqtt/emq-dashboard v2.1.0
dep_emq_retainer  = git https://github.com/emqtt/emq-retainer v2.1.0
dep_emq_recon     = git https://github.com/emqtt/emq-recon v2.1.0
dep_emq_reloader  = git https://github.com/emqtt/emq-reloader v2.1.0

# emq auth/acl plugins
dep_emq_auth_clientid = git https://github.com/emqtt/emq-auth-clientid v2.1.0
dep_emq_auth_username = git https://github.com/emqtt/emq-auth-username v2.1.0
dep_emq_auth_ldap     = git https://github.com/emqtt/emq-auth-ldap v2.1.0
dep_emq_auth_http     = git https://github.com/emqtt/emq-auth-http v2.1.0
dep_emq_auth_mysql    = git https://github.com/emqtt/emq-auth-mysql v2.1.0
dep_emq_auth_pgsql    = git https://github.com/emqtt/emq-auth-pgsql v2.1.0
dep_emq_auth_redis    = git https://github.com/emqtt/emq-auth-redis v2.1.0
dep_emq_auth_mongo    = git https://github.com/emqtt/emq-auth-mongo v2.1.0
...
dep_emq_stomp = git https://github.com/emqtt/emq-stomp v2.1.0
