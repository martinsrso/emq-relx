...
DEPS += emqttd emq_modules emq_dashboard emq_retainer emq_recon emq_reloader \
        ...
        emq_lua_hook emq_auth_jwt emq_cleanspeak_plugin emq_es_storage emq_throttle_plugin \
...
# web_hook lua_hook
dep_emq_cleanspeak_plugin = git https://github.com/lucbarr/emq_cleanspeak_plugin.git test-ex-1.5
